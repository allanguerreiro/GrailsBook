...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'book.label', default: 'Editar Livro')}"/>
...
<g:form method="post">
    ...
    <h2><g:message code="book.update"/></h2>
    <table>
        <tbody>
        <tr>
    ...
    <div id="actionbar" class="menuButton">
        <g:actionSubmitImage value="Atualizar" action="saveOrUpdate"
                             src="${resource(dir: 'images/skin', file: 'atualizar.png')}"/>
    </div>
</g:form>
</body>
</html>